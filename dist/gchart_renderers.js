  ...
  callWithJQuery(function($) {
    ...
    makeGoogleChart = function(chartType, extraOptions) {
      return function(pivotData, opts) {
        var agg, colKey, colKeys, dataArray, dataTable, defaults, fullAggName, groupByTitle, h, hAxisTitle, headers, numCharsInHAxis, options, result, row, rowKey, rowKeys, title, tree2, vAxisTitle, val, wrapper, x, y, _base, _base1, _i, _j, _len, _len1, _ref, _ref1, _ref2;
        defaults = {
          localeStrings: {
            vs: "vs",
            by: "by"
        ...
        if ((_ref = (_base = opts.gchart).width) == null) {
          _base.width = window.innerWidth / 1.4;
        }
