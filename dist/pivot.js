  ...
  */
  ...
  PivotData = (function() {
    ...
    function PivotData(input, opts) {
      var _this = this;
      this.getAggregator = function(rowKey, colKey) {
        return PivotData.prototype.getAggregator.apply(_this, arguments);
      };
      this.getRowKeys = function() {
        return PivotData.prototype.getRowKeys.apply(_this, arguments);
      };
      this.getColKeys = function() {
        return PivotData.prototype.getColKeys.apply(_this, arguments);
      };
      this.sortKeys = function() {
        return PivotData.prototype.sortKeys.apply(_this, arguments);
      };
      this.arrSort = function(a, b) {
        return PivotData.prototype.arrSort.apply(_this, arguments);
      };
      this.natSort = function(as, bs) {
        return PivotData.prototype.natSort.apply(_this, arguments);
      };
