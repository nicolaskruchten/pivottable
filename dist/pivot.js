  ...
  callWithJQuery(function($) {
    ...
    */
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      var a, aggregator, attrLength, axisValues, c, colList, defaults, existingOpts, i, initialRender, k, opts, pivotTable, refresh, refreshDelayed, renderer, rendererControl, shownAggregators, shownAttributes, shownDragDrop, tblCols, tr1, tr2, uiTable, unusedAttrsVerticalAutoCutoff, unusedAttrsVerticalAutoOverride, x, _fn, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      if (overwrite == null) {
        overwrite = false;
      }
      ...
      try {
        ...
        shownAggregators = (function() {
          var _j, _len1, _results;
          _results = [];
          for (_j = 0, _len1 = shownAttributes.length; _j < _len1; _j++) {
            c = shownAttributes[_j];
            if (__indexOf.call(opts.hiddenFromAggregators, c) < 0) {
              _results.push(c);
            }
          }
          return _results;
        })();
        shownDragDrop = (function() {
          var _j, _len1, _results;
          _results = [];
          for (_j = 0, _len1 = shownAttributes.length; _j < _len1; _j++) {
            c = shownAttributes[_j];
            if (__indexOf.call(opts.hiddenFromDragDrop, c) < 0) {
              _results.push(c);
            }
          }
          return _results;
        ...
        if (!isNaN(unusedAttrsVerticalAutoCutoff)) {
          attrLength = 0;
          for (_j = 0, _len1 = shownDragDrop.length; _j < _len1; _j++) {
            a = shownDragDrop[_j];
            attrLength += a.length;
          }
        ...
        for (i in shownDragDrop) {
          if (!__hasProp.call(shownDragDrop, i)) continue;
          c = shownDragDrop[i];
          _fn(c);
        }
        ...
        for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
          x = _ref3[_k];
          this.find(".pvtCols").append(this.find(".axis_" + ($.inArray(x, shownDragDrop))));
        }
        _ref4 = opts.rows;
        for (_l = 0, _len3 = _ref4.length; _l < _len3; _l++) {
          x = _ref4[_l];
          this.find(".pvtRows").append(this.find(".axis_" + ($.inArray(x, shownDragDrop))));
        }
        ...
        refreshDelayed = function() {
          ...
          if (numInputsToProcess !== 0) {
            ...
            for (x = _m = 0; 0 <= numInputsToProcess ? _m < numInputsToProcess : _m > numInputsToProcess; x = 0 <= numInputsToProcess ? ++_m : --_m) {
              ...
              for (_n = 0, _len4 = shownAggregators.length; _n < _len4; _n++) {
                attr = shownAggregators[_n];
