...
callWithJQuery ($, c3) ->
    ...
    $.pivotUtilities.c3_renderers =
        ...
        "Step Chart": makeC3Chart(type: "step")
        "Step Area Chart": makeC3Chart(type: "area-step")
        "Spline Chart": makeC3Chart(type: "spline")
        "Spline Area Chart": makeC3Chart(type: "area-spline")
        "Pie Chart": makeC3Chart(type: "pie")
        "Donut Chart": makeC3Chart(type: "donut")
