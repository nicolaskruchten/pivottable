    ...
    try {
      ...
      _fn = function(c) {
        ...
        showFilterList = function(e) {
          valueList.css({
            // NOTE: Cube19 changes at work...
            left: e.currentTarget.offsetLeft + 6, // BEFORE: e.pageX
            top: e.currentTarget.offsetTop + 6    // BEFORE: e.pageY
            // END: Cube19 changes.
          }).toggle();
          $('.pvtSearch').val('');
          return $('label').show();
      ...
      refreshDelayed = (function(_this) {
        return function() {
          ...
          pivotTable.wrapInner($("<div class=\"scrollable\" />"));  // NOTE: Cube19 changes at work...
