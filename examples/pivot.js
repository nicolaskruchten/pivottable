(function() {
  var $, PivotData, addCommas, aggregatorTemplates, aggregators, convertToArray, dayNames, deriveAttributes, derivers, forEachRecord, getPivotData, mthNames, naturalSort, numberFormat, pivotTableRenderer, renderers, spanSize, zeroPad;
  ...
  */
  ...
  naturalSort = __bind(function(as, bs) {
  ...
  */
  $.fn.pivotUI = function(input, inputOpts, overwrite) {
    ...
    try {
      ...
      _fn = function(c) {
        var attrElem, btns, filterItem, k, keys, v, valueList, _j, _len2, _ref3;
        keys = (function() {
          var _results;
          _results = [];
      ...
      refresh = __bind(function() {
        ...
        if (opts.autoSortUnusedAttrs) {
          ...
          return $(unusedAttrsContainer).children("li").sort(__bind(function(a, b) {
            return natSort($(a).text(), $(b).text());
          }, this)).appendTo(unusedAttrsContainer);
        }
      }, this);
      refresh();
